...
add_bullet_text(slide, Inches(1.5), Inches(4.8), Inches(10), Inches(2), [
    "514 커밋  |  43,974줄  |  134개 기능  |  AI 99%+ 작성",
    "2026-02 ~ 06  |  서영재",
...
make_table_slide("프로젝트 핵심 수치", ["항목", "수치"], [
    ...
    ["총 커밋", "514개 (AI 99%+ 작성)"],
    ["소스 코드", "43,974줄 / 215개 파일"],
    ["API 엔드포인트", "73개"],
    ["페이지/뷰", "39개"],
    ["DB 모델", "29개 (Prisma)"],
    ["구현 기능", "134개 (features.md 기준)"],
...
make_two_col_slide("KPT 회고",
    ...
    [
        ...
        "리팩터링을 미루지 말았어야",
        "  514커밋 중 refactor 3건뿐 > 기술 부채 축적",
        "테스트 커버리지 부족",
        "  8개 테스트 파일로 43,974줄은 부족",
...
make_two_col_slide("적합 영역 vs 부적합 영역",
    ...
    [
        ...
        "",
        "비용 효율성",
        "  AI 구독 월 수십만 원 vs 외주 수천만~1억 원",
        "  웹 비전공자 1명이 2.5개월에 DCIM 구축",
    ],
    "부적합",
    [
