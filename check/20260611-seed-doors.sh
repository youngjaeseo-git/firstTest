...
echo "=== Seed doors (positions relative to building rect x=2,y=2) ==="
...
('el-door-top','$L3','DOOR','DOOR',698,10,40,4,'{\"orientation\":\"horizontal\"}',90,NOW(),NOW()),
('el-door-mid','$L3','DOOR','DOOR',678,336,40,4,'{\"orientation\":\"horizontal\"}',91,NOW(),NOW()),
('el-door-side','${L2:-$L3}','DOOR','DOOR',678,488,4,40,'{\"orientation\":\"vertical\"}',92,NOW(),NOW());"
