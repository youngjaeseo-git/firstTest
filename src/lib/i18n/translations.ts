...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ko: {
    ...
    "alertSettings.channels.desc": "알림이 전달되는 채널입니다. 에스컬레이션 정책에서 사용됩니다.",
    ...
    "alertSettings.escalation.deleteMsg": "이 에스컬레이션 정책을 삭제하시겠습니까?",
    "alertSettings.escalation.deleteTitle": "정책 삭제",
    "alertSettings.escalation.deleted": "정책이 삭제되었습니다",
    "alertSettings.escalation.desc": "특정 심각도의 알림이 확인되지 않을 때 채널로 알림을 보냅니다.",
    ...
    "alertSettings.maintenance.deleteMsg": "이 유지보수 창을 삭제하시겠습니까?",
    "alertSettings.maintenance.deleteTitle": "유지보수 창 삭제",
    "alertSettings.maintenance.deleted": "유지보수 창이 삭제되었습니다",
    "alertSettings.maintenance.desc": "계획된 유지보수 동안 알림을 억제합니다. 활성 창은 해당 알림을 음소거합니다.",
    ...
    "capacity.forecast.growthChartSub": "과거 실적(실선) + 12개월 전망(점선)",
    "capacity.forecast.growthSummary": "리소스별 월간 증가량",
    "capacity.forecast.loading": "예측 계산 중…",
    "capacity.forecast.longTerm": "용량 예측",
    "capacity.forecast.longTermSub": "장비 이력 기반 장기 성장 추세 및 용량 소진 예측",
    ...
    "capacity.forecast.urgentWarning": "용량 소진이 임박합니다 (6개월 이내)",
