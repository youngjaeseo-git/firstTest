...
export function ServerDetailClient({ instance, hostIp }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Section 6: PCM (Performance Counters) ── */}
      <SectionHeader title={t("server.pcm")} />
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <MetricChart
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <MetricChart
          title={t("server.pcmCacheOps")}
          unit="ops/s"
          series={[
            {
              label: "L2 Hits",
              query: queries.pcmL2CacheHits(instance),
              color: "#06b6d4",
            },
            {
              label: "L2 Misses",
              query: queries.pcmL2CacheMisses(instance),
              color: "#f43f5e",
            },
            {
              label: "L3 Hits",
              query: queries.pcmL3CacheHits(instance),
              color: "#10b981",
            },
            {
              label: "L3 Misses",
              query: queries.pcmL3CacheMisses(instance),
              color: "#ef4444",
            },
          ]}
          durationMin={duration.value}
