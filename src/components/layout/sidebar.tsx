...
const navigation = [
  ...
  { name: "Racks", href: "/racks", icon: HardDriveIcon },
  { name: "Alerts", href: "/alerts", icon: BellIcon },
  { name: "Assets", href: "/assets", icon: PackageIcon },
  { name: "Capacity", href: "/capacity", icon: BarChartIcon },
...
// Simple SVG icon components (replace with lucide-react after npm install)
